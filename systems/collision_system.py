...
class CollisionSystem:
    ...
    @staticmethod
    def check_player_collision(px, py, pen_list, townhall_list, lumber_yard_list=None):
    ...
    @staticmethod
    def check_sheep_collision(sx, sy, sw, sh, pen_list, townhall_list, lumber_yard_list=None):
